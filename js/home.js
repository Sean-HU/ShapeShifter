...
window.onload = function() {
    ...
    var shapeRelations = ['./shapes/sphere.png', './shapes/square.png', './shapes/sphere.png', './shapes/square.png'];

    loadShapes(availableShapes);
    window.setTimeout(function() {loadShapeRelations(shapeRelations)}, 5000);
}